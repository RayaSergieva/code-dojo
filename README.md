...
![No Build Step](https://img.shields.io/badge/Build_Step-None-orange?style=for-the-badge)
...
A dojo-themed browser arcade — my journey from **4th grade HTML/CSS/JavaScript** to writing real game logic and structure.
...
| <kbd>K</kbd> | Throw shuriken | 15 spirit |
| <kbd>L</kbd> | Dash forward with invincibility | 10 spirit |
| <kbd>I</kbd> | Ki burst — clear the entire screen | 100 spirit |
...
To play it online without downloading anything, visit the live version:
**https://rayasergieva.github.io/code-dojo/** *(enable GitHub Pages in Settings → Pages to activate this link)*
...
<tr><td><code>sprites.js</code></td><td>Character sprite rendering (ninja, enemies, boss)</td></tr>
...
<tr><td><code>main.js</code></td><td>Game state, the update / draw cycle, and the main loop</td></tr>
</table>
